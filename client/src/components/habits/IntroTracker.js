...
const IntroTracker = () => {
  ...
  console.log(pointsToSend, setPointstoSend)
  ...
  return (
    ...
    <>
      ...
      <div className="intro-points-button">
        <Link to="/habits/">
          {filteredArray.length === 0 ?        
            <button className="ui inverted icon right labeled button"><i aria-hidden="true" className="angle double right icon"></i>  Go to your main tracker page</button>
            :
            <>
